...
_ramble() {
    ...
    then
        ...
        RAMBLE_COMPREPLY="attributes clean commands config create data debug deployment docs edit filter-groups help info license list mirror on python repo results simplify software-definitions style unit-test workspace"
    fi
}
...
_ramble_simplify() {
    if $list_options
    then
        RAMBLE_COMPREPLY="-h --help -t --type -r --repo -d --diff -a --apply"
    else
        RAMBLE_COMPREPLY=""
    fi
}
