...
_ramble() {
    ...
    then
        ...
        RAMBLE_COMPREPLY="attributes clean commands config debug deployment docs edit help info license list mirror on python repo results software-definitions style unit-test workspace zeppelin"
    fi
}
