...
class ArgparseCompletionWriter(ArgparseWriter):
    ...
    def body(self, positionals: List[Any], optionals: List[Any], subcommands: List[Any]) -> str:
    ...
    def positionals(self, positionals: List[Any]) -> str:
    ...
    def optionals(self, optionals: List[Any]) -> str:
    ...
    def subcommands(self, subcommands: List[Any]) -> str:
