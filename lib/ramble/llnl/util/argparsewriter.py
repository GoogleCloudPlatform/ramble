...
class ArgparseCompletionWriter(ArgparseWriter):
    ...
    def format(self, cmd: Command) -> str:
        ...
        Parameters:
            cmd (Command): parsed information about a command or subcommand
        ...
        subcommands = []
        if cmd.subcommands:
            _, _, subcommands = zip(*cmd.subcommands)
    ...
    def end_function(self, prog: Optional[str] = None) -> str:
    ...
    def body(self, positionals: Sequence[Any], optionals: Sequence[Any], subcommands: Sequence[Any]) -> str:
    ...
    def positionals(self, positionals: Sequence[Any]) -> str:
    ...
    def optionals(self, optionals: Sequence[Any]) -> str:
    ...
    def subcommands(self, subcommands: Sequence[Any]) -> str:
