...
def test_n_ranks_correct_defaults(workspace_name):
    ...
    with ramble.workspace.read(workspace_name) as ws:
        ...
        assert "basic.test_wl2.series1_4" in exp_set.experiments.keys()
        assert "basic.test_wl2.series1_6" in exp_set.experiments.keys()
...
def test_n_nodes_correct_defaults(workspace_name):
    ...
    with ramble.workspace.read(workspace_name) as ws:
        ...
        assert "basic.test_wl2.series1_4_2" in exp_set.experiments.keys()
        assert "basic.test_wl2.series1_6_3" in exp_set.experiments.keys()
...
def test_processes_per_node_correct_defaults(workspace_name):
    ...
    with ramble.workspace.read(workspace_name) as ws:
        ...
        assert "basic.test_wl2.series1_4_2" in exp_set.experiments.keys()
        assert "basic.test_wl2.series1_6_2" in exp_set.experiments.keys()
